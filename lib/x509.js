...
pki.getTBSCertificate = function(cert) {
  ...
  var tbs = asn1.create(asn1.Class.UNIVERSAL, asn1.Type.SEQUENCE, true, [
    ...
    asn1.create(asn1.Class.UNIVERSAL, asn1.Type.SEQUENCE, true, [
      // notBefore
      _isDateGeneralizedTime(cert.validity.notBefore) ? (
        asn1.create(asn1.Class.UNIVERSAL, asn1.Type.GENERALIZEDTIME, false,
          asn1.dateToGeneralizedTime(cert.validity.notBefore))
      ) : (
        asn1.create(asn1.Class.UNIVERSAL, asn1.Type.UTCTIME, false,
          asn1.dateToUtcTime(cert.validity.notBefore))
      ),
      // notAfter
      _isDateGeneralizedTime(cert.validity.notAfter) ? (
        asn1.create(asn1.Class.UNIVERSAL, asn1.Type.GENERALIZEDTIME, false,
          asn1.dateToGeneralizedTime(cert.validity.notAfter))
      ) : (
        asn1.create(asn1.Class.UNIVERSAL, asn1.Type.UTCTIME, false,
...
/**
 * Check whether a date is a valid GeneralizedTime or not.
 *
 * @param date the date to be checked.
 *
 * @return true if a valid GeneralizedTime, otherise false.
 */
function _isDateGeneralizedTime(date) {
